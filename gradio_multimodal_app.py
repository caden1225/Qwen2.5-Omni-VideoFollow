...
class QwenOmniInference:
    ...
    def predict(self, messages, system_prompt, voice="Chelsie", save_audio_path=None):
        ...
        # 处理音频
        if audio is not None and save_audio_path:
...
class MultimodalProcessor:
    def __init__(self):
        ...
        self.model_path = os.getenv("MODEL_PATH", "/home/caden/workplace/models/Qwen2.5-Omni-3B")
        self.temp_files = []
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                model_path = gr.Textbox(
                    label="🔗 模型路径",
                    value="/home/caden/workplace/models/Qwen2.5-Omni-3B",
